         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
					    <img src="<?php echo $value['image']; ?>" height="100px" width="150px;" alt="" /></br>
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="type">
							...
							<?php
							   if($value['type']==0){ ?>
							   <option selected ="select" value="0">Featured</option>
							    <option value="0">General</option>
							   <?php } else{ ?>
								    <option  selected ="select"  value="1">General</option>
